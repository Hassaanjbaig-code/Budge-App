...
RSpec.describe 'Groups', type: :system do
    ...
    it 'should create a group' do
        ...
        expect(page).to have_selector('img[src="https://images.unsplash.com/photo-1583840726841-c35239a17b23?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80"]', visible: true)
    end
end
end